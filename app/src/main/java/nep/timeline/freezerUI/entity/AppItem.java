...
public class AppItem {
    ...
    public boolean allowAPIInjection;
    ...
    private AppItem(String appName, String packageName, int userId, Drawable appIcon, PackageInfo packageInfo, int oomLevel, boolean white, boolean black, int backgroundLevel, boolean intervalUnfreeze, int intervalUnfreezeDelay, boolean backgroundPlay, boolean backgroundIntent, boolean notificationKeep, int locationCheck, boolean ignoreRecording, boolean bluetoothCheck, boolean ignoreBinder, boolean allowAPIInjection, boolean socket, boolean netReceive, boolean networkCheck, boolean idle, int killProcCount, int whiteProcCount) {
        ...
        this.allowAPIInjection = allowAPIInjection;
        this.socket = socket;
    ...
    public AppItem(String appName, String packageName, int userId, Drawable appIcon, PackageInfo packageInfo, boolean isFrozen, String frozenType, String notFrozenReason, long rss, long swap, boolean compacted, int applicationProcessCount, int frozenProcessCount) {
        this.category = PackageUtils.categoryUndefined(packageInfo.applicationInfo) ? Category.Undefined : (PackageUtils.isGame(packageInfo.applicationInfo) ? Category.Game : (PackageUtils.isAudioOrVideo(packageInfo.applicationInfo) ? Category.Music : (PackageUtils.isMap(packageInfo.applicationInfo) ? Category.Map : (Build.VERSION.SDK_INT > Build.VERSION_CODES.S_V2 && PackageUtils.isAccessibility(packageInfo.applicationInfo) ? Category.Accessibility : Category.Other))));
        this.appName = appName;
        this.packageName = packageName;
        this.userId = userId;
    ...
    public static AppItem createApp(String appName, String packageName, int userId, Drawable appIcon, PackageInfo packageInfo, int oomLevel, boolean white, boolean black, int backgroundLevel, boolean intervalUnfreeze, int intervalUnfreezeDelay, boolean backgroundPlay, boolean backgroundIntent, boolean notificationKeep, int locationCheck, boolean ignoreRecording, boolean bluetoothCheck, boolean ignoreBinder, boolean allowAPIInjection, boolean socket, boolean netReceive, boolean networkCheck, boolean idle, int killProcCount, int whiteProcCount) {
        return new AppItem(appName, packageName, userId, appIcon, packageInfo, oomLevel, white, black, backgroundLevel, intervalUnfreeze, intervalUnfreezeDelay, backgroundPlay, backgroundIntent, notificationKeep, locationCheck, ignoreRecording, bluetoothCheck, ignoreBinder, allowAPIInjection, socket, netReceive, networkCheck, idle, killProcCount, whiteProcCount);
    }

    public static AppItem createFrozen(String appName, String packageName, int userId, Drawable appIcon, PackageInfo packageInfo, boolean isFrozen, String frozenType, String notFrozenReason, long rss, long swap, boolean compacted, int applicationProcessCount, int frozenProcessCount) {
        return new AppItem(appName, packageName, userId, appIcon, packageInfo, isFrozen, frozenType, notFrozenReason, rss, swap, compacted, applicationProcessCount, frozenProcessCount);
    }
