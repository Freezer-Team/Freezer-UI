...
import nep.timeline.freezerUI.ui.app.LocalAppState
import nep.timeline.freezerUI.ui.app.LocalIsWideScreen
import nep.timeline.freezerUI.ui.app.LocalNavigator
import nep.timeline.freezerUI.ui.app.isInDarkTheme
import nep.timeline.freezerUI.ui.custom.BackNavigationIcon
import nep.timeline.freezerUI.ui.custom.blend.ColorBlendToken
import nep.timeline.freezerUI.ui.custom.blur.BgEffectBackground
            ...
            item(key = "about") {
                Column(
                    ...
                    Card(
                        ...
                        BasicComponent(
                            title = "View Document",
                            summary = stringResource(R.string.home_click_to_learn_freezer),
                            endActions = {
                                Icon(
                            ...
                            onClick = { uriHandler.openUri("https://docs.sakion.top") },
                        )
                        ArrowPreference(
                            title = "Join Channel",
                            endActions = {
                            ...
                            onClick = { uriHandler.openUri("https://discord.gg/PnXAkEXtf9") },
                        )
                        ArrowPreference(
                            title = "Join Group",
                            endActions = {
                            ...
                            onClick = { uriHandler.openUri("https://t.me/make_freezer_great_again") },
                        )
                    }
                    Card(
                        modifier = Modifier
                        ...
                        ArrowPreference(
                            ...
                            onClick = {
                                uriHandler.openUri("https://github.com/Freezer-Team/Freezer-Script")
                            },
                        )
                    }
